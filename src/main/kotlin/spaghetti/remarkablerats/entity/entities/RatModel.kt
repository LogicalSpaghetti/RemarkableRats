    ...
    companion object {
        val texturedModelData: TexturedModelData
            get() {
                ...
                val Rat = modelPartData.addChild(
                    "Rat",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.0f, 24.0f, 0.0f)
                )

                val BodyBottom = Rat.addChild(
                    "BodyBottom",
                ...
                val Head = Chest.addChild(
                    "Head",
                    ModelPartBuilder.create().uv(12, 13).cuboid(-1.5f, -1.5f, -4.0f, 3.0f, 3.0f, 4.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 2.0f, -4.0f)
                )

                val Nose = Head.addChild(
                    "Nose",
                    ModelPartBuilder.create().uv(13, 24).cuboid(-0.5f, -4.5f, -10.5f, 1.0f, 1.0f, 1.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 4.0f, 6.0f)
                )

                val Ears = Head.addChild(
                    "Ears",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.0f, -1.5f, -1.0f)
                )

                val LeftEar = Ears.addChild(
                    "LeftEar",
                    ModelPartBuilder.create(),
                ...
                val whiskers = Head.addChild(
                    "whiskers",
                    ModelPartBuilder.create().uv(4, 27).cuboid(-3.5f, -2.5f, 0.0f, 7.0f, 5.0f, 0.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 0.0f, -4.0f)
                )

                val FrontLegs = Chest.addChild(
                    "FrontLegs",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.0f, 3.0f, -2.0f)
                )

                val FrontLeftLeg = FrontLegs.addChild(
                    "FrontLeftLeg",
                    ModelPartBuilder.create().uv(21, 20).cuboid(2.0f, -4.0f, -5.0f, 1.0f, 2.0f, 2.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 4.0f, 4.0f)
                )

                val FrontLeftFoot = FrontLeftLeg.addChild(
                    "FrontLeftFoot",
                    ModelPartBuilder.create().uv(10, 20).cuboid(-0.5f, 0.0f, -1.5f, 1.0f, 1.0f, 2.0f, Dilation(0.0f)),
                    ModelTransform.pivot(2.5f, -2.0f, -4.5f)
                )

                val FrontRightLeg = FrontLegs.addChild(
                    "FrontRightLeg",
                    ModelPartBuilder.create().uv(22, 11).cuboid(-3.0f, -4.0f, -5.0f, 1.0f, 2.0f, 2.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 4.0f, 4.0f)
                )

                val FrontRightFoot = FrontRightLeg.addChild(
                    "FrontRightFoot",
                    ModelPartBuilder.create().uv(5, 17).cuboid(-0.5f, 0.0f, -1.5f, 1.0f, 1.0f, 2.0f, Dilation(0.0f)),
                    ModelTransform.pivot(-2.5f, -2.0f, -4.5f)
                )

                val Tail = BodyBottom.addChild(
                    "Tail",
                    ModelPartBuilder.create().uv(22, 5).cuboid(-0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 3.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, -2.0f, 2.0f)
                )

                val tail2 = Tail.addChild(
                    "tail2",
                    ModelPartBuilder.create().uv(18, 25).cuboid(-0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 6.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 0.0f, 3.0f)
                )

                val BackLegs = Rat.addChild(
                    "BackLegs",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.0f, -3.0f, 1.0f)
                )

                val BackLeftLeg = BackLegs.addChild(
                    "BackLeftLeg",
                    ModelPartBuilder.create().uv(5, 20).cuboid(3.0f, -1.0f, -1.0f, 1.0f, 3.0f, 3.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 0.0f, 0.0f)
                )

                val BackLeftFoot = BackLeftLeg.addChild(
                    "BackLeftFoot",
                    ModelPartBuilder.create().uv(13, 20).cuboid(3.0f, -2.0f, -1.0f, 1.0f, 1.0f, 3.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 4.0f, -1.0f)
                )

                val BackRightLeg = BackLegs.addChild(
                    "BackRightLeg",
                    ModelPartBuilder.create().uv(17, 0).cuboid(-4.0f, -2.0f, -1.0f, 1.0f, 1.0f, 3.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 4.0f, -1.0f)
                )

                val BackRightFoot = BackRightLeg.addChild(
                    "BackRightFoot",
                    ModelPartBuilder.create().uv(0, 17).cuboid(-4.0f, -5.0f, 0.0f, 1.0f, 3.0f, 3.0f, Dilation(0.0f)),
                    ModelTransform.pivot(0.0f, 0.0f, 0.0f)
                )
